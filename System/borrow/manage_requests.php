...
require_once '../../includes/auth_check.php';  // Auth check
require_once '../config/db.php';

// Only admin allowed (adjust role check as needed)
...
$stmt = $pdo->query("
    SELECT 
        br.borrow_id, br.quantity, br.date_borrowed, br.expected_return,
        ...
        <tr>
            ...
            <td>
                <form method="post" style="display:inline;">
                    <input type="hidden" name="borrow_id" value="<?= htmlspecialchars($req['borrow_id']) ?>">
