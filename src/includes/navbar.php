...
<header>
  ...
  <nav class="navbar">
      <a href="/src/index.php">Dashboard</a>
      <a href="/src/assets/list.php">Assets</a>
      
      <?php if ($role === 'admin'): ?>
          <a href="/src/users/list.php">Users</a>
          <a href="/src/fines/manage.php">Fines</a>
          <a href="/src/logs/view_logs.php">Logs</a>
      <?php elseif ($role === 'member'): ?>
          <a href="/src/borrow/request.php">Borrow</a>
          <a href="/src/fines/manage.php">Fines</a>
      <?php endif; ?>
      
      <a href="/src/notifications/index.php">Notifications</a>
      <?php if ($username): ?>
          <a href="/src/auth/logout.php" class="logout">Logout</a>
      <?php else: ?>
          <a href="/src/auth/login.php" class="logout">Login</a>
      <?php endif; ?>
  </nav>
</header>
</body>
